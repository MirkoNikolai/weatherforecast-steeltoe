...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'Mini_Sample'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->Mini-Sample]
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[0].sources[0].delegate.transformations[3] (RewritePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Path 'Sample.csproj' matched 'Sample(.*)' with groups {g0=Sample.csproj, g1=.csproj} and was rewritten to 'Mini-Sample.csproj'
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.sln' matched 'Sample(.*)' with groups {g0=Sample.sln, g1=.sln} and was rewritten to 'Mini-Sample.sln'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->Mini-Sample, sample-app->weatherforecast-stee...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->Mini_Sample]
